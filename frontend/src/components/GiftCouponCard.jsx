  ...
  >
    <div className='space-y-4'>
        <div>
            ...
            type='text'
            id='voucher'
            className='block w-full rounded-lg border-gray-600 bg-gray-700 p-2.5 text-sm text-white placeholder-gray-400 focus:border-emerald-500 focus:ring-emerald-500'
